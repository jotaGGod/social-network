 ...
 *
 * This middleware applies a validation schema to the request parameters and headers. If validation fails, an error is thrown. Otherwise, control is passed to the next middleware.
 *
